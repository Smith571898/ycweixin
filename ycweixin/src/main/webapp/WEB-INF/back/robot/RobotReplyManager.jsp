	...
	<table id="ReplyTable" toolbar="#tb">
		...
		<div id="twoledgedialog" style="display: none;">
			<form method="post" id="twoknowledge">
				...
				问题内容
				<input type="text" id="subquestion" disabled="disabled">
				<br /> <br /> 请输入小辰回答
				<input type="text" id="subanswer" name="answer">
				<center>
		...
		<div id="jokedialog" style="display: none;">
			<form method="post" id="jokefrom">
				...
				笑话内容<br />
				<textarea style="width: 330px; height: 100px;" id="joke_content" name="joke_content"></textarea>
				<br /> <br />
				<center>
