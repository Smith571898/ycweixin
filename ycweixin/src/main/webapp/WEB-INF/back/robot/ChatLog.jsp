					...
					columns : [ [
							...
							},
							{
								...
								formatter : function(create_time) {
									...
									var tt = new Date(
											parseInt(create_time) * 1000)
											.toLocaleString().substr(0)
...
<body>
	<table id="LogTable" toolbar="#tb">
		<div id="tb">
			选择日期查询日期
			<input id="dd" type="text" class="easyui-datebox" " name="createtime" data-options="formatter:myformatter,parser:myparser">
			<script type="text/javascript">
