...
<form action="douploadForeverpicbat.action" method="post" enctype="multipart/form-data">

	<p>

		图片上传前预览：<input  id="fpics" type="file" name="fpics"  onchange="javascript:setImagePreviews(this)" accept="image/*" multiple="multiple" /> 
